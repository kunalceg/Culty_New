...
app.use("/api/v1/login", require("./routes/login.route.js"));
app.use("/api/v1/verify",require("./route/verify.route.js"))
app.use("/api/v1/myfarm",require("./routes/myfarm.route.js"));
app.use("/api/v1/farmlandinfo", require("./routes/farmlandinfo.route.js"));
app.use("/api/v1/block",require("./routes/block.route.js"));
app.use("/api/v1/deviceassociation",require("./routes/deviceassociation.route.js"));
app.use("/api/v1/telemetrydata", require("./routes/telemetrydata.route.js"));
